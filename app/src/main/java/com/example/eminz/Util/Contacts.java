...
public class Contacts extends AsyncTask<Void, Void, List<? extends HashMap<String, ?>>> {

    private SMSScheduler activity;
    ...
    public void setActivity(SMSScheduler activity) {
